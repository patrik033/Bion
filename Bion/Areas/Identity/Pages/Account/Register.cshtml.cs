...
namespace Bion.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(!await _roleManager.RoleExistsAsync(StaticDetails.ManagerRole))
                {
                    ...
                    await _roleManager.CreateAsync(new IdentityRole(StaticDetails.CustomerRole));
                }
                if (result.Succeeded)
                {
                    //lägger till användaren som manager
                    await _userManager.AddToRoleAsync(user, StaticDetails.ManagerRole);
                    //lägger till som customer
